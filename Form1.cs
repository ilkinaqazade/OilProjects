...
namespace OilProjects
{
    public partial class Form1 : Form
    {
        ...
        private void TotalBuylbr_TextChanged(object sender, EventArgs e)
        {
            
        }

        private void CoffeeBox_CheckedChanged(object sender, EventArgs e)
        {
            
        }


        private void snickersBox_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void redbullBox_CheckedChanged(object sender, EventArgs e)
        {

        }

        private void spriteBox_CheckedChanged(object sender, EventArgs e)
        {
        ...
        private void CoffeeBox_TextChanged(object sender, EventArgs e)
        {
